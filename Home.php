...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="toppic nav-link active" href="Home.php" aria-current="page"
                            >หน้าหลัก
    ...
    <div class="banner">
        ...
        <button type="button" class="btn buttonhome" onclick="window.location.href = 'Signup.php'">สมัครสมาชิก</button>
        <div class="photoban1">
